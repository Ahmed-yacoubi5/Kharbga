...
export const TRANSLATIONS = {
  en: {
    ...
    guestModeNotice: "Playing as Guest: Match stats are temporary and won't be saved. Sign in with Google to permanently track your Win/Loss record!",
    guestSessionNotice: "Guest Session (Unsaved)",
    saveStatsPrompt: "Sign in with Google to save your Win/Loss progress!",
    statsSavedNotice: "Permanent Cloud Stats Active",
    hallTimeout: "10m Inactivity Timeout",
  ...
  fr: {
    ...
    guestModeNotice: "Mode Invité : Vos statistiques sont temporaires et ne seront pas sauvegardées. Connectez-vous avec Google pour enregistrer vos victoires et défaites !",
    guestSessionNotice: "Session Invité (Non sauvegardée)",
    saveStatsPrompt: "Connectez-vous avec Google pour sauvegarder vos progrès !",
    statsSavedNotice: "Statistiques Cloud Permanentes",
    hallTimeout: "10 min d'inactivité",
  ...
  ar: {
    ...
    guestUser: "لاعب زائر",
    guestModeNotice: "وضع الزائر: نتائج المباريات مؤقتة ولن تُحفظ في حساب دائم. سجل الدخول بحساب Google لحفظ وتتبع سجل انتصاراتك وهزائمك!",
    guestSessionNotice: "جلسة زائر (غير محفوظة)",
    saveStatsPrompt: "سجل الدخول بحساب Google لحفظ تقدمك ونسبة فوزك!",
    statsSavedNotice: "إحصائيات سحابية دائمة محفوظة",
    hallTimeout: "مهلة 10 دقائق عند عدم النشاط",
